...
Define the supported Flutter application shell, its Home and Settings navigation, and the non-terminating Exit-to-Home behavior that keeps clipboard link detection available.
